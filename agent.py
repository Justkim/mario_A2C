...
def main():
    ...
    if flag.ON_DESKTOP:
        ...
        made_env=SubprocVecEnv([env.make_train_0, env.make_train_0,env.make_train_0,env.make_train_0,env.make_train_0,env.make_train_0,env.make_train_0,env.make_train_0,env.make_train_0])
        nsteps=128
